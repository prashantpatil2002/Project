...
function Spectrogram(settings){
    ...
    this.padding = typeof settings.padding === "undefined" ? {top: 20, right: 60, bottom: 150, left: 75} : settings.padding;    
    ...
    this.width = typeof settings.width === "undefined" ? 1200 : settings.width;
    this.height = typeof settings.height === "undefined" ? 500 : settings.height;
...
this.colorSchemes = {
    ...
    "purple": ["#000000", "#3f007f", "#5f00af", "#7f00df", "#af00ff", "#cf00ff", "#ef00ff", "#ff00ef", "#ff00cf", "#ff00af", "#ff007f"],
    "orange": ["#000000", "#ff6a00", "#ff8a00", "#ffa700", "#ffc700", "#ffea00", "#ffff00", "#eaff00", "#c7ff00", "#a7ff00", "#8aff00"],
    "gray": ["#000000", "#1a1a1a", "#333333", "#4d4d4d", "#666666", "#808080", "#999999", "#b3b3b3", "#cccccc", "#e6e6e6", "#ffffff"],
    "custom2":['#240D11', '#391F1F', '#4F302C', '#62403C', '#69575B', '#877775', '#A19794', '#BAB1AC', '#CCC3C1', '#E2E2F1'],
    "custom1": ["#8B00FF","#4B0082","#0000FF","#00FF00","#FFFF00","#FFA500","#FF0000"]
}
...
$(this.selector + " select[name='colorScheme']").on("change", function(){
    _this.currentColorScheme = $(this).val();
    _this.hexColorArray = _this.colorSchemes[_this.currentColorScheme];
...
this.hexColorArray = vibgyorColors;
	...
	this.hexToRgb = function(hex) {
		var grey   = parseInt(hex.substring(1, 3),16);
		var custom2 = parseInt(hex.substring(3, 5),16);
		var purple  = parseInt(hex.substring(5, 7),16);
 
		return [grey, custom2, purple];
	};
